...
export default function HeroSection() {
  ...
  const stats = [
    { icon: MapPin, value: '5+', label: h.statDestinations },
    { icon: Users, value: '500+', label: h.statTravelers },
    { icon: Star, value: '4.9', label: h.statRating },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pt-24">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
            {h.title1}{' '}
            <span className="text-mokara-orange">{h.titleHighlight}</span>
            <br />
            {h.title2}
          </h1>
